...
<body>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/Banner1.jpg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to OSMS ( Online Services Management System )</h1>
      <p class="font-italic">Customer's Happiness is our Aim</p>
      <a href="Requester/RequesterLogin.php" class="btn btn-success mr-5">Login</a>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Dharmendra Kr.</h4>
              <p class="card-text">Very prompt service from the office. Electrician Hamid was a pleasant person and https://docs.google.com/spreadsheets/d/1qlD-W84uE9ZH2hFumNDkGQGlHlzY52TUsA8_xV1CGqA/edit?usp=sharingwith the job. Thank you.</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Subham Kumar</h4>
              <p class="card-text">Itaque illo explicabo voluptatum, saepe libero rerum, ad
                ducimus voluptas
                nesciunt debitis numquam.</p>
            </div>
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        OSMS Pvt Ltd, <br>
        Sec IV, Lucknow <br>
        Uttar Pradesh - 226202 <br>
        Phone: +91 7497956631 <br>
        ...
        OSMS Pvt Ltd, <br>
        Dhar Road, Indore <br>
        Madhya Pradesh - 452002 <br>
        Phone: +91 7052478550 <br>
        <a href="#" target="_blank">www.osms.com</a> <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by @Dev_Dharm0001&copy; 2018.
          </small>
